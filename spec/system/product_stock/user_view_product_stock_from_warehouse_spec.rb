...
describe 'Usuário vê estoque' do
    it 'na tela do galpão' do
        ...
        within("section#stock_products") do
            ...
            expect(page).to have_content "3 x #{product_a.identifier}"
            expect(page).to have_content "2 x #{product_b.identifier}"
        end
    end
    ...
    it 'e dá baixa em um item' do
        ...
        visit root_path
        click_on 'Aeroporto SP'
        select product.identifier, from: 'Item para Saída'
        ...
        expect(page).to have_content "1 x #{product.identifier}"
    end
end